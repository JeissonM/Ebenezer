...
class CreateDatoscompestudiantesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('datoscompestudiantes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('datoscompestudiantes');
    }
}
