...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('documentosanexos.index')}}"><i class="fa fa-file-o"></i>Documentos Anexos</a></li>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVO DOCUMENTO ANEXO</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('documentosanexos.store')}}">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('documentosanexos.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Incluye un nuevo documento anexo. Para esto será preciso ingresar la descripción. Se finaliza al hacer clic en la opción guardar.</p>
            </div>
