...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">EDITAR CIRCUNSCRIPCIÓN</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('circunscripcion.update',$circunscripcion->id)}}">
                @csrf
                <input name="_method" type="hidden" value="PUT" />
                 <div class="col-md-6">
                    <div class="form-group">
                        <label>Nombre de la circunscripción</label>
                        <input class="form-control" type="text" required="required" name="nombre" value="{{$circunscripcion->nombre}}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Descripción</label>
                        <input class="form-control" type="text" required="required" name="descripcion"value="{{$circunscripcion->descripción}}">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Modifique la información de una circunscripción teniendo en cuenta las reglas planteadas en el formulario de creación.</p>
            </div>
