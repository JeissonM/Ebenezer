...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('agendacita.edit',$aso->id)}}"><i class="fa fa-calendar-times-o"></i> Fechas
                Programadas</a></li>
...
{{--                            <input class="form-control" type="text" placeholder="Hora en que da inicio la entrevista"--}}
{{--                                   maxlength="4" name="horainicio" id="horainicio">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group">--}}
{{--                            <label>Hora Fin (Formato 24 Horas, sin los 2 puntos ":", ejemplo 1400)</label>--}}
{{--                            <input class="form-control" type="text" placeholder="Hora en que da fin la entrevista"--}}
{{--                                   maxlength="4" name="horafin" id="horafin">--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    <div class="col-md-6">
                        <div class="form-group">
                            <label></label>
                            <button class="btn btn-success icon-btn pull-left" type="button" onclick="horario()"><i
                                    class="fa fa-fw fa-lg fa-plus-square-o"></i>Agregar Horario
                            </button>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12" style="margin-top: 20px !important">
                        <div class="form-group">
                            ...
                            <a class="btn btn-danger icon-btn pull-left" href="{{route('agendacita.edit',$aso->id)}}"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Seleccione una fecha del calendario y configure el listado de horarios disposibles para
                        entrevistas ese día, cada horario se compone de <b>Hora Inicio y Hora Fin</b>, la hora debe ser
                        escrita en formato 24 horas; inicia a las 00:00 y termina en las 24:00. No debe colocar los dos
                        puntos "<b>:</b>" en la hora, la hora debe escribirse así, por ejemplo: para escribir 8AM usted
                        debe escribir 0800, para escribir 3PM usted debe escribir 1500, para escribir 7PM usted debe
                        escribir 1900, etc.</p>
                </div>
