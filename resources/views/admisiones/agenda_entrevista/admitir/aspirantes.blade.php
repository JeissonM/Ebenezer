                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$a->estado}}</td>
                            <td>
                                <a href="{{route('admitiraspirantes.show',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Continuar" style="margin-left: 10px;"><i class="fa fa-arrow-right"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
