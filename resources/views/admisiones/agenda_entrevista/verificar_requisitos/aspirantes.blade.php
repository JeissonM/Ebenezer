                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('verificarrequisitos.listarrequisitos',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Verificar Requisitos" style="margin-left: 10px;"><i class="fa fa-check"></i></a>
                                @else
                                NO HAY ENTREVISTA AGENDADA
                                @endif
                            </td>
                        </tr>
                        @endforeach
