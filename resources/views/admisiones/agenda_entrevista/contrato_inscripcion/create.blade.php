...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Agregar Contrato</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">AGREGAR NUEVO CONTRATO</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('contratoinscripcion.store')}}">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="contrato" name="contrato" rows="10" cols="80" required></textarea>
                    </div>
                </div>
