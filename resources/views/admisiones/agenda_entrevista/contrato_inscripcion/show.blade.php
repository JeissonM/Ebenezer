...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Ver Contrato</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <h3 class="text-success">EL CONTRATO ESTÁ DEFINIDO COMO ACTUAL</h3>
            @else
            <h3 class="text-danger">EL CONTRATO ESTÁ DEFINIDO COMO NO ACTUAL</h3>
            @endif
            {!!$contrato->contrato!!}
        </div>
    </div>
