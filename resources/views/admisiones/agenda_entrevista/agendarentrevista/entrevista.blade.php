...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('entrevista.listaraspirantes',[$a->unidad_id,$a->periodoacademico_id,$a->jornada_id,$a->grado_id])}}"><i class="fa fa-list"></i> Aspirantes</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$c->estado}}</td>
                            <td>
                                <a href="{{route('entrevista.agendarcita',[$a->id,$c->id])}}" style="margin-left: 10px;" data-toggle="tooltip" title="Programar Entrevista" style="margin-left: 10px;"><i class="fa fa-check"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
