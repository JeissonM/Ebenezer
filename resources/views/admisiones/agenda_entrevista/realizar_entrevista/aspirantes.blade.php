                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('realizarentrevista.show',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Continuar" style="margin-left: 10px;"><i class="fa fa-arrow-right"></i></a>
                                @else
                                NO SE AGENDÓ UNA ENTREVISTA
                                @endif
                            </td>
                        </tr>
                        @endforeach
