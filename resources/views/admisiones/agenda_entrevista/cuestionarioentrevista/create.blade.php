...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Agregar Cuestionario</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">AGREGAR NUEVO CUESTIONARIO</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('cuestionarioentrevista.store')}}">
                @csrf
                <div class="col-md-12">
