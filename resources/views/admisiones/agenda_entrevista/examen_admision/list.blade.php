...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Realizar Examen de Admisión</a></li>
</ol>
@endsection
@section('content')
<div class="box">
...
<script type="text/javascript">
    ...
    function ir() {
        location.href = url + "admisiones/examenadmision/inicio/aspirantes/" + $("#unidad_id").val() + "/" + $("#periodoacademico_id").val() + "/" + $("#jornada_id").val() + "/" + $("#grado_id").val() + "/listar";
    }
</script>
@endsection