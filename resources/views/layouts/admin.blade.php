        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="{{route('menu.matricula')}}"><i class="fa fa-tasks"></i> <span>Matrícula</span></a>
                    </li>
                    @else
                    <li><a href="{{route('menu.matricula')}}"><i class="fa fa-tasks"></i> <span>Matrícula</span></a>
                    </li>
                    @endif
                    @endif
                    @if(session()->exists('MOD_PANEL-ACUDIENTE'))
                    @if($location=='inscripcion')
                    <li class="active"><a href="{{route('menu.inscripcion')}}"><i class="fa fa-edit"></i> <span>Inscripción</span></a>
                    </li>
                    @else
                    <li><a href="{{route('menu.inscripcion')}}"><i class="fa fa-edit"></i> <span>Inscripción</span></a>
                    </li>
                    @endif
                    @endif
                    @if(session()->exists('MOD_ACADEMICO'))
                    @if($location=='academico')
                    <li class="active"><a href="{{route('menu.academico')}}"><i class="fa fa-book"></i> <span>Académico</span></a>
                    </li>
                    @else
                    <li><a href="{{route('menu.academico')}}"><i class="fa fa-book"></i> <span>Académico</span></a>
                    </li>
                    @endif
                    @endif
                    @if(session()->exists('MOD_ACADEMICO-DOCENTE'))
                    @if($location=='academicodocente')
                    <li class="active"><a href="{{route('menu.academicodocente')}}"><i class="fa fa-book"></i> <span>Académico</span></a>
                    </li>
                    @else
                    <li><a href="{{route('menu.academicodocente')}}"><i class="fa fa-book"></i> <span>Académico</span></a>
                    </li>
                    @endif
                    @endif
