...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('aulavirtual.menuaulaestudiante',$gmd->id)}}"><i class="fa fa-vimeo"></i> Panel Aula Virtual</a></li>
    <li><a href="{{route('forodiscusion.estudianteinicio',$gmd->id)}}"><i class="fa fa-bullhorn"></i> Foros de Discusión</a></li>
    <li class="active"><a>Crear Tema</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <form class="form" role='form' method="POST" action="{{route('forodiscusion.storeforo')}}">
                @csrf
                <input type="hidden" name="grupomateriadocente_id" value="{{$gmd->id}}" />
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Título del Foro</label>
                        <input class="form-control" type="text" required="required" name="titulo">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <textarea id="editor1" name="contenido" rows="10" cols="80">
                            Escriba contenido del tema
                        </textarea>
                    </div>
                </div>
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('forodiscusion.estudianteinicio',$gmd->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Esta funcionalidad permite la comunicación entre estudiantes y estudiantes con respecto a temáticas de la materia.</p>
            </div>
