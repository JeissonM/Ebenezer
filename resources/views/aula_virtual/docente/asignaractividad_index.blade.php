 ...
 <ol class="breadcrumb">
     ...
     <li class="active"><a> Asignar Actividades, Exámenes & Ebeduc</a></li>
 </ol>
 @endsection
 @section('content')
 <div class="box">
     <div class="box-header with-border">
         <h3 class="box-title">ASIGNAR ACTIVIDADES, EXAMENES & EBEDUC</h3>
                 ...
                 <div class="panel box box-success">
                     ...
                     <div id="collapse{{$e->id}}" class="panel-collapse collapse">
                         <div class="box-body">
                             ...
                             <div class="col-md-6">
                                 <h4><b>ACTIVIDADES</b>
                                     <a href="{{route('asignaractividad.asignar',[$gmd->id,$e->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> AGREGAR ACTIVIDAD</a>
                                 </h4>
                             ...
                             <div class="col-md-6">
                                 <h4><b>PRUEBA EBEDUC</b>
                                     <a href="{{route('asignarebeduc.asignar',[$gmd->id,$e->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> AGREGAR PRUEBA EBEDUC</a>
                                 </h4>
                                 @if($e->actividades!=null)
                                 <div class="table-responsive">
                                     <table class="table table-bordered table-striped table-hover">
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <p>Esta funcionalidad permite la asignación de actividades y simulacros EBEDUC para una materia, grado y evaluación académica en particular.</p>
             </div>
