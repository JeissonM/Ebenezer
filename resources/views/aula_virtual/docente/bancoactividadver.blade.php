 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             ...
             <h4 class="text-center text-danger">Solo se visualizan documentos PDF, si el documento de la actividad no se visualiza correctamente puede descargarlo desde <a href="{{asset('documentos/aulavirtual/'.$a->recurso)}}" download="{{$a->recurso}}">aquí.</a></h4>
