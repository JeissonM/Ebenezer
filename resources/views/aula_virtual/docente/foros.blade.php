 ...
 <ol class="breadcrumb">
     ...
     <li><a href="{{route('aulavirtual.menuauladocente',$gmd->id)}}"><i class="fa fa-bullhorn"></i> Panel Aula Virtual</a></li>
 ...
 <div class="box">
     <div class="box-header with-border">
         ...
         <div class="box-tools pull-right">
             ...
             <a href="{{route('forodiscusion.create',$gmd->id)}}" class="btn btn-box-tool" data-toggle="tooltip" data-original-title="Agregar Nuevo Tema de Discusión">
                 ...
                 <table id="tb" class="table table-bordered table-striped table-hover">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td><a href="{{route('forodiscusion.leerforo',$f->id)}}" style='margin-left: 10px; cursor: pointer;' data-toggle='tooltip' title='Continuar al Foro'><i class='fa fa-arrow-right'></i></a></td>
                         </tr>
                         @endforeach
                     </tbody>
                 </table>
