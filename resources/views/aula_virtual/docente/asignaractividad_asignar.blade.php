 ...
 <ol class="breadcrumb">
     ...
     <li class="active"><a> Asignar</a></li>
 </ol>
 @endsection
 @section('content')
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             <h4>Datos de la Actividad (Llene los datos solicitados, seleccione la actividad y presione ASIGNAR)</h4>
             <form id="asignar-form" method="POST" action="{{route('asignaractividad.asignarstore')}}">
                 @csrf
                 ...
                 <div class="col-md-12">
                     <label>Listado de Actividades en la Materia</label>
                     <div class="table-responsive">
                         <table id="tb" class="table table-bordered table-striped table-hover">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a target="_blank" href="{{route('actividad.show',[$gmd->id,$a->id])}}" style='margin-left: 10px; cursor: pointer; color:green;' data-toggle='tooltip' title='Ver'><i class='fa fa-eye'></i></a>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <p>Esta funcionalidad permite la asignación de actividades para una materia, grado y evaluación académica en particular.</p>
             </div>
