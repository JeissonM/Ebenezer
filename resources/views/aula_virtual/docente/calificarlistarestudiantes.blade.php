                 ...
                 <table id="tb" class="table table-bordered table-striped table-hover">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td>{{$c->realizo}}</td>
                             <td><a href="{{route('calificaciondocente.vistacalificar',[$gmd->id,$a->id,$c->estudiante_id])}}" style='margin-left: 10px; cursor: pointer;' data-toggle='tooltip' title="Calificar"><i class="fa fa-check"></i></a></td>
                         </tr>
                         @endforeach
                         @endif
                     </tbody>
