 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             ...
             <form class="form" role='form' method="POST" action="{{route('preguntas.update')}}">
                 @csrf
                 ...
                 <div class="col-md-6">
                     <div class="form-group">
                         ...
                         <input class="form-control" type="text" value="{{$a->puntos}}" required="required" name="puntos">
                     </div>
                 </div>
                 <div class="col-md-6">
                     <div class="form-group">
                         ...
                         <select class="form-control" required="required" name="tipo">
                             @if($a->tipo=='RESPONDA')
                             <option selected value="RESPONDA">RESPONDA</option>
                             <option value="SELECCION MULTIPLE">SELECCION MULTIPLE</option>
                             @else
                             <option value="RESPONDA">RESPONDA</option>
                             <option selected value="SELECCION MULTIPLE">SELECCION MULTIPLE</option>
                             @endif
                         </select>
                     </div>
                 </div>
                 <div class="col-md-12">
                     <div class='form-group'>
                         ...
                         <textarea id='pregunta' name='pregunta' rows='10' cols='80' required>{{$a->pregunta}}</textarea>
                     </div>
                 </div>
                 <div class="col-md-12" style="margin-top: 20px !important">
                     <div class="form-group">
                         ...
                         <a class="btn btn-danger icon-btn pull-left" href="{{route('preguntas.index',$gmd->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                     </div>
                 </div>
             </form>
         </div>
