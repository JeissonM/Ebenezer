...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <form class="form" role='form' method="POST" action="{{route('forodiscusion.store')}}">
                @csrf
                ...
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('forodiscusion.docenteinicio',$gmd->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
