 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             ...
             <form class="form" role='form' enctype="multipart/form-data" method="POST" action="{{route('preguntas.store')}}">
                 @csrf
                 <input type="hidden" name="gmd_id" value="{{$gmd->id}}" />
                 <div class="col-md-6">
                     <div class="form-group">
                         <label>Puntos de la Preguntas</label>
                         <input class="form-control" type="text" required="required" name="puntos">
                     </div>
                 </div>
                 <div class="col-md-6">
                     <div class="form-group">
