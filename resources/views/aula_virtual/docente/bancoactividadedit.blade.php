                    ...
                    <form class="form" role='form' method="POST" action="{{route('actividad.update')}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{$a->nombre}}" required="required"
                                       name="nombre">
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Unidad</label>
                                <select class="form-control" name="ctunidad_id" id="ctunidad_id" onchange="getLogros()"
                                        required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ctunidadtema_id" id="ctunidadtema_id"
                                    ...
                                    <option selected
                                            value="{{$a->ctunidadtema_id}}">{{$a->ctunidadtema->titulo}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <form class="form" role='form' enctype="multipart/form-data" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class='form-group'>
                                    ...
                                    <textarea id='recurso' name='recurso' rows='10' cols='80'
                                              required>{{$a->recurso}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
