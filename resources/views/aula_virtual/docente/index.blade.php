 ...
 <ol class="breadcrumb">
     ...
     <li class="active"><a>Inicio Docente</a></li>
 </ol>
 @endsection
 @section('content')
 <div class="box">
             ...
             if (msg !== "null") {
                 ...
                 $.each(m, function(index, item) {
                     html = html + "<tr><td>" + item.codigo + "</td><td>" + item.materia + "</td><td>" + item.grupo + "</td>" +
                         "<td><a href='" + url + "aulavirtual/docente/inicio/" + item.gmd_id + "/menu/aula/docente' style='margin-left: 10px; cursor: pointer;' data-toggle='tooltip' title='Continuar al Aula'><i class='fa fa-arrow-right'></i> CONTINUAR AL AULA</a></td></tr>";
                 });
