 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             <h4>Datos de la Prueba Ebeduc</h4>
             <form class="form" role='form' enctype="multipart/form-data" method="POST" action="{{route('ebeduc.store')}}">
                 @csrf
                 <input type="hidden" name="gmd_id" value="{{$gmd->id}}" />
                 <div class="col-md-6">
                     <div class="form-group">
                         <label>Nombre de la Prueba Ebeduc</label>
                 ...
                 <div class="col-md-12" style="margin-top: 20px !important">
                     <div class="form-group">
                         ...
                         <a class="btn btn-danger icon-btn pull-left" href="{{route('ebeduc.index',$gmd->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                     </div>
                 </div>
             </form>
         </div>
