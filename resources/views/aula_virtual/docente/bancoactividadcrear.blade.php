 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
             ...
             <form class="form" role='form' enctype="multipart/form-data" method="POST" action="{{route('actividad.store')}}">
                 @csrf
                 ...
                 <div class="col-md-6">
                     <div class="form-group">
                         ...
                         <select class="form-control" name="tipo" required id="tipo" onchange="cambiar()">
                             ...
                             <option value="ACTIVIDAD-VACIA">LA ACTIVIDAD ES SOLO PARA INGRESAR LA CALIFICACIÓN</option>
                 ...
                 <div class="col-md-12" style="margin-top: 20px !important">
                     <div class="form-group">
                         ...
                         <a class="btn btn-danger icon-btn pull-left" href="{{route('actividad.index',$gmd->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                     </div>
                 </div>
             </form>
         </div>
