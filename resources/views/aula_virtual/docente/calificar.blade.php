 ...
 <ol class="breadcrumb">
     ...
     <li class="active"><a> Calificar Actividades, Exámenes & Ebeduc</a></li>
 </ol>
 @endsection
 @section('content')
 <div class="box">
                                     ...
                                     <table class="table table-bordered table-striped table-hover">
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><a href="{{route('calificaciondocente.listarestudiantes',[$gmd->id,$a->id])}}" style='margin-left: 10px; cursor: pointer;' data-toggle='tooltip' title="Listar Estudiantes"><i class="fa fa-list"></i></a></td>
                                             </tr>
                                             @endif
                                             @endforeach
                                         </tbody>
