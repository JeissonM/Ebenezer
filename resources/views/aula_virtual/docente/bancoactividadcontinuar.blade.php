 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12">
                     ...
                     <table id="tb" class="table table-bordered table-striped table-hover">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>{{$p->puntos}}</td>
                                 <td>
                                     <a href="{{route('actividad.addpregunta',[$gmd->id,$a->id,$p->id])}}" style="margin-left: 10px;" data-toggle="tooltip" title="Agregar Pregunta" style="margin-left: 10px;"><i class="fa fa-check"></i></a>
                                 </td>
                             </tr>
                             @endforeach
                         </tbody>
             ...
             <div class="col-md-6">
                 <div class="callout callout-danger" style="padding: 5px; padding-left: 20px; text-align: center;">
                     <h2>Preguntas Cargadas en la Actividad</h2>
                 </div>
                 <div class="table-responsive">
                     <table class="table table-bordered table-striped table-hover">
                         <thead>
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <a href="{{route('actividad.deletepregunta',[$gmd->id,$py->id])}}" style="margin-left: 10px; color:red;" data-toggle="tooltip" title="Retirar Pregunta"><i class="fa fa-times"></i></a>
                                 </td>
                             </tr>
                             @endforeach
                             @endif
