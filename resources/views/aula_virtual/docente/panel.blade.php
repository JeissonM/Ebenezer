 ...
 <div class="box">
     ...
     <div class="box-body">
         ...
         <div class="col-md-12" style="text-align: center;">
             ...
             <div class="col-md-4">
                 <a href="{{route('preguntas.index',$gmd->id)}}" class="btn btn-raised btn-app btn-primary btn-block">
                     <i class="fa fa-question"></i> Banco de Preguntas
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a href="{{route('actividad.index',$gmd->id)}}" class="btn btn-raised btn-app btn-danger btn-block">
                     <i class="fa fa-list"></i> Banco de Actividades
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a href="{{route('forodiscusion.docenteinicio',$gmd->id)}}" class="btn btn-raised btn-app btn-danger btn-block">
                     <i class="fa fa-bullhorn"></i> Foros de Discusión
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a href="{{route('ebeduc.index',$gmd->id)}}" class="btn btn-raised btn-app btn-warning btn-block">
                     <i class="fa fa-check"></i> Gestionar Simulacro EBEDUC
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a href="{{route('asignaractividad.index',$gmd->id)}}" class="btn btn-raised btn-app btn-primary btn-block">
                     <i class="fa fa-edit"></i> Asignar Actividades, Exámenes & Ebeduc
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a href="{{route('calificaciondocente.index',$gmd->id)}}" class="btn btn-raised btn-app btn-success btn-block">
                     <i class="fa fa-list-ol"></i> Calificaciones
                     <div class="ripple-container"></div>
                 </a>
             </div>
             <div class="col-md-4">
                 <a target="_blank" href="{{route('aulavirtual.imprimir',$gmd)}}" class="btn btn-raised btn-app btn-block">
                     <i class="fa fa-print"></i> Imprimir Planilla Calificaciones
                     <div class="ripple-container"></div>
                 </a>
             </div>
         </div>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <p>Esta funcionalidad le permite gestionar el <b>Aula Virtual</b>, asignar actividades, evaluaciones, calificar al estudiante y responder inquietudes sobre las temáticas de su cátedra a los estudiantes.</p>
             </div>
