...
@section('content')
    <div class="login-box" style="width: 60% !important;">
        <div class="login-logo">
            <a href="{{url('/')}}">Ebenezer <b>Valledupar</b> - Registro</a>
        </div>
        <!-- /.login-logo -->
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <input type="number"
                               ...
                               placeholder="Identificación" id="identificacion" name="identificacion"
                               value="{{ old('identificacion') }}" required autofocus>
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control{{ $errors->has('nombres') ? ' is-invalid' : '' }}"
                               placeholder="Nombres" id="nombres" name="nombres" value="{{ old('nombres') }}" required
                               autofocus>
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control{{ $errors->has('apellidos') ? ' is-invalid' : '' }}"
                               placeholder="Apellidos" id="apellidos" name="apellidos" value="{{ old('apellidos') }}"
                               required autofocus>
                        <span class="fa fa-user form-control-feedback"></span>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                               placeholder="Correo Electrónico" id="email" name="email" value="{{ old('email') }}"
                               required autofocus>
