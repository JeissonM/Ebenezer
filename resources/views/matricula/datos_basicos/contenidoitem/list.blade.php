...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Contenido de Items de Materia</a></li>
</ol>
@endsection
@section('content')
<div class="box">
        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$a->codigomateria}}</td>
                        <td>{{$a->nombre}}</td>
                        <td>{{$a->descripcion}}</td>
                        <td>{{$a->area->nombre}}</td>
                        <td>
                            <a href="{{route('contenidoitem.show',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Continuar" style="margin-left: 10px;"><i class="fa fa-arrow-right"></i></a>
