...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Gestión de Grupos</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">GESTIÓN DE GRUPOS O CURSOS PARA LOS GRADOS</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12" style="margin-top: 20px !important">
            <div class="form-group">
                <button class="btn btn-success icon-btn pull-left" onclick="ir()"><i class="fa fa-fw fa-lg fa-save"></i>Gestionar Grupos</button>
...
<script type="text/javascript">
    ...
    function ir() {
        location.href = url + "matricula/grupo/" + $("#unidad_id").val() + "/" + $("#periodoacademico_id").val() + "/" + $("#jornada_id").val() + "/" + $("#grado_id").val() + "/continuar";
    }
</script>
@endsection