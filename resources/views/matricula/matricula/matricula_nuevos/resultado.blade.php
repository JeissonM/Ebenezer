...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('matricularnuevos.index')}}"><i class="fa fa-check"></i> Matricular Estudiantes Nuevos</a></li>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">RESULTADO DE LA CONVERSIÓN</h3>
    ...
    <div class="box-body">
        <div class="col-md-12" style="margin-top: 40px;">
            <h4>Proceso de matrícula finalizado. Los resultados fueron cargados en un archivo que puede descargar desde el siguiente enlace: <a href="{{asset('documentos/log/'.$response['archivo'])}}" target="_blank">Descargar Archivo</a></h4>
        </div>
