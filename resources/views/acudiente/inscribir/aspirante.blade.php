        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                ...
                <form class="form" enctype="multipart/form-data" role='form' method="POST"
                      action="{{route('inscripcion.aspirantestore')}}">
                    @csrf
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pais_id" name="pais_id"
                                        onchange="getEstados('pais_id', 'estado_id', 'ciudad_id')">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="estado_id" name="estado_id"
                                        onchange="getCiudades('estado_id', 'ciudad_id')">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="discapacidad" id="discapacidad" onclick="display()">
                                    <option value="SI">SI</option>
                                    <option value="NO" selected>NO</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4" id="tipo_discapacidad" style="display: none">
                            <div class="form-group">
                                <label>Tipo de discapacidad*</label>
                                <input type="text" class="form-control" name="tipo_discapacidad" id="discapacidad_tipo">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
{{--                        </div>--}}
                    ...
                    <div class="col-md-12" style="margin-top: 20px !important">
                        <div class="form-group">
                            ...
                            <a class="btn btn-danger icon-btn pull-left" href="{{route('inscripcion.aspirante')}}"><i
    ...
    <script type="text/javascript">
        ...
        function display() {
            if ($("#discapacidad").val() === 'SI') {
                $("#tipo_discapacidad").removeAttr('style');
                $("#discapacidad_tipo").attr('required', 'required');
            } else {
                $("#tipo_discapacidad").attr('style', 'display:none');
                $("#discapacidad_tipo").removeAttr('required');
            }
        }
