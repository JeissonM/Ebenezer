...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">ENTREVISTA</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <h3>Tenga en cuenta que una vez programada la cita no podrá modificar los datos del aspirante.</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ENTREVISTA AGENDADA
                                @else
                                <a href="{{route('entrevistaa.show',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Programar Entrevista" style="margin-left: 10px;"><i class="fa fa-calendar-check-o">Agendar</i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Esta funcionalidad permitirá al usuario programar la entrevista para cada aspirante.</p>
            </div>
