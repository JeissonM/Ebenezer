...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('entrevistaa.index')}}"><i class="fa fa-check-list-o"></i> Entrevista</a></li>
    <li class="active"><a>Agendar Cita</a></li>
</ol>
@endsection
@section('content')
<div class="box">
                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$c->estado}}</td>
                            <td>
                                <a href="{{route('entrevistaa.agendar',[$a->id,$c->id])}}" style="margin-left: 10px;" data-toggle="tooltip" title="Programar Entrevista" style="margin-left: 10px;"><i class="fa fa-check"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
