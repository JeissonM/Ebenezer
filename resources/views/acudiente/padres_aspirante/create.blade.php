...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('padresaspirantes.lista',$a->id)}}"><i class="fa fa-users"></i> Padres</a></li>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('padresaspirantes.store')}}">
                @csrf
                <input type="hidden" name="aspirante_id" value="{{$a->id}}" />
                <h5 class="text-danger">Los campos con asterísco(*) son obligatorios</h5>
                @if($acu!=null)
                <div class="col-md-12">
                    <h4 style="color: green;"><i style="color: green;" class="fa fa-warning"></i> Usted es acudiente del aspirante seleccionado, ¿desea registrarse como padre/madre sin tener que llenar el formulario? si la respuesta es si: escriba los datos obligatorios para verificar su identidad y de click en GUARDAR</a></h4>
                </div>
                ...
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('padresaspirantes.lista',$a->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
