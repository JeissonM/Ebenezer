...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Responsable Financiero Aspirante</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">SELECCIÓN DE ASPIRANTE</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('responsablefaspirante.show',$a->id)}}" data-toggle="tooltip" title="Responsable Financiero" style="margin-left: 10px; color:green"><i class="fa fa-arrow-right"></i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
