...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Modificar Aspirantes</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">MODIFICAR ASPIRANTES</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <h3>Solo puede modificar si no hay entrevista asignada</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ENTREVISTA AGENDADA
                                @else
                                <a href="{{route('aspirante.menu',$a->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Modificar Aspirante" style="margin-left: 10px;"><i class="fa fa-edit"></i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
