...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Datos Acudiente</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">INGRESAR LOS DATOS DEL ACUDIENTE</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            @if(count($ac)>0)
            <h3 class="text-success">Usted ya se encuentra registrado como acudiente.</h3>
            @else
            <h3 class="text-danger">Usted está registrado como persona natural en el sistema sin embargo no es acudiente aún, debe dirigirse a la funcionalidad <b>Inscripción> Inscribir Aspirante</b></h3>
            @endif
        </div>
        @else
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('inscripcion.store')}}">
                @csrf
...
{{--                </div>--}}
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('inscripcion.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Esta funcionalidad permitirá al usuario ingresar la información personal del acudiente.</p>
            </div>
