...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Documentos Anexos al Proceso de Inscripción</a></li>
</ol>
@endsection
@section('content')
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <h3>El día de la entrevista asegurese de llevar los requisitos indicados para cada aspirante</h3>
                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$a->estado}}</td>
                            <td>
                                <a href="{{route('inscripcion.documentosanexosver',[$a->unidad_id,$a->grado_id,$a->jornada_id])}}" style="margin-left: 10px;" data-toggle="tooltip" title="Ver Documentos" style="margin-left: 10px;"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
