...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">EDITAR SISTEMA DE EVALUACÍN</h3>
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                <form class="form" role='form' method="POST"
                      action="{{route('sistemaevaluacion.update',$sistema->id)}}">
                    @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" step="0.01"
                                   placeholder="Nota final del sistema de evaluación" value="{{$sistema->nota_final}}"
                                   name="nota_final">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" step="0.01" value="{{$sistema->nota_aprobatoria}}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="estado">
                                @if($sistema->estado == 'EN DESUSO')
                                    <option selected value="EN DESUSO">EN DESUSO</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permite crear y actualizar el sistema de evaluación en el cual se determina la
                        ...
                        <br>Edite el sitemas de evaluación seleccionado. <br><strong>Nota:</strong> Solo un sistema de evaluación
