...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a>Asignar Estudiantes a Ceremonia</a></li>
    </ol>
@endsection
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">ASIGNAR ESTUDIANTES A CEREMONIA</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permite al usuario asignar a los estudiantes a una ceremonia de grado.</p>
                </div>
    ...
    <script type="text/javascript">
        ...
        function ir() {
            ...
            if (cer.length <= 0) {
                ...
                location.href = url + "academico/ceremoniaestudiante/" + $("#unidad_id").val() + "/" + $("#periodoacademico_id").val() + "/" + $("#jornada_id").val() + "/" + $("#grado_id").val() + "/" + $("#ceremonia_id").val() + "/listar";
            }
        }
    </script>
@endsection
