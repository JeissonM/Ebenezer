...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">CREAR NUEVA CEREMONIA</h3>
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                <form class="form" role='form' method="POST" action="{{route('ceremonia.store')}}">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"
                                   placeholder="Lugar de la ceremonia" name="lugar" required="required">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Fecha Inicial</label>
                            <input class="form-control" type="datetime-local" required="required"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime-local" placeholder="Fecha y hora final" required="required"
                                   name="fechahorafin">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="periodoacademico_id" name="periodoacademico_id" required="required">
