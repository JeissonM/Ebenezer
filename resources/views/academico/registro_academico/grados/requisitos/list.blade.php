...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a> Requisitos</a></li>
    </ol>
@endsection
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">REQUISITOS DE GRADO</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#modal" title="Ayuda">
                    <i class="fa fa-question"></i></button>
                <a href="{{route('requisitogrado.create')}}" class="btn btn-box-tool"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permite gestionar los requisitos de grados que luego serán asignados a los mismos.</p>
                </div>
