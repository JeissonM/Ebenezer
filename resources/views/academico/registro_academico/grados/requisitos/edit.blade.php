...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">EDITAR REQUISITO</h3>
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                <form class="form" role='form' method="POST"
                      action="{{route('requisitogrado.update',$requisito->id)}}">
                    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permite gestionar los requisitos de grados que luego serán asignados a los mismos. Edite los datos del requisito seleccionado.</p>
                </div>
