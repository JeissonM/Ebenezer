...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a>Acudientes</a></li>
    </ol>
@endsection
@section('content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                <a href="{{route('acudientes.crear',$a->id)}}" class="btn btn-box-tool"
                    ...
                    <table id="example1" class="table table-bordered table-striped table-hover">
                        ...
                        @foreach($acudientes as $res)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('acudientes.delete',$res->id)}}"
