...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('menu.hojadevidaestudiante',$est->id)}}"><i class="fa fa-edit"></i> Menú</a></li>
...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{$est->unidad->nombre}}</td>
                            <td>{{$est->grado->etiqueta}}</td>
                            <td>{{$est->estado}}</td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-md-12">
                <form class="form" role='form' method="POST" action="{{route('hojadevida.modcomplementarios')}}">
                    @csrf
                    ...
                    <div class="col-md-12" style="margin-top: 20px !important">
                        <div class="form-group">
                            ...
                            <a class="btn btn-danger icon-btn pull-left" href="{{route('menu.hojadevidaestudiante',$est->id)}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permitirá al usuario modificar los datos del estudiante seleccionado.</p>
                </div>
