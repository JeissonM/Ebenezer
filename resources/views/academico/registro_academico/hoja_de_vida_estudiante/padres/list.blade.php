...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">PADRES DEL ESTUDIANTE</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#modal" title="Ayuda">
                    <i class="fa fa-question"></i></button>
                <a href="{{route('padresestudiante.crear',$a->id)}}" class="btn btn-box-tool" data-toggle="tooltip" data-original-title="Agregar Padre/Madre">
                    ...
                    <table id="example1" class="table table-bordered table-striped table-hover">
                        ...
                        @foreach($padres as $p)
                            <tr>
                                ...
                                <td>{{$p->acudiente}}</td>
                                <td>
                                    <a href="{{route('padresestudiante.delete',$p->id)}}" style="margin-left: 10px; color:red;" data-toggle="tooltip" title="Eliminar Padre/Madre"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
