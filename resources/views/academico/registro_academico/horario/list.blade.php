...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a>Horario</a></li>
    </ol>
@endsection
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">GESTIÓN DE HORARIO</h3>
        ...
        <div class="box-body">
            ...
            <div class="col-md-12" style="margin-top: 20px !important">
                <div class="form-group">
                    <button class="btn btn-success icon-btn pull-left" onclick="ir()"><i class="fa fa-fw fa-lg fa-save"></i>Gestionar Horario</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esta funcionalidad permite cargar el archivo adjunto del horario al grupo seleccionado.</p>
                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function ir() {
            location.href = url + "academico/horario/" + $("#grupo_id").val() + "/edit";
        }
