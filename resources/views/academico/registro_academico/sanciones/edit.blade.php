...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                <form class="form" role='form' method="POST" action="{{route('sancion.update',$sancion->id)}}">
                    @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" required="" value="{{$sancion->fechainicio}}"
                                   name="fechainicio">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" value="{{$sancion->fechafin}}" name="fechafin">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Sanción*</label>
                            <textarea class="form-control" rows="5" name="sancion"
                                      required="required">{{$sancion->sancion}}</textarea>
                        </div>
                    </div>
