...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVO COMPONENTE</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('componente.store')}}">
                @csrf
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Componente</label>
                        <input type="text" maxlength="250" class="form-control " name="componente" required>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Esta funcionalidad permite agragar un nuevo componente.</p>
            </div>
