...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('competencia.index')}}"><i class="fa fa-check"></i> Competencias</a></li>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVA COMPETENCIA</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('competencia.store')}}">
                @csrf
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Competencia</label>
                        <input type="text" maxlength="250" class="form-control" name="competencia" required>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Esta funcionalidad permite agragar una nueva competencia.</p>
            </div>
